...
public class SocialNetwork {
  ...
  /**
   * Expande a dimensao do vector "requests", quando este enche.
   */
  ...
  //new variable similar to numMembers but for the requests
  ...
  public void addFriendshipRequest(String m1, String m2) {
    assert !m1.equals(m2); //ainda não existe pedido anterior entre os dois
