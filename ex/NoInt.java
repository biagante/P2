...
class NoInt {
	...
	// get valor nó 2
	System.out.print("Valor do nó 2: ");
	...
	// imprime comprimento com função iterativa
	System.out.printf("LengthI: %d\n", lengthI(primeiro));
	
	// imprime comprimento com função recursiva
	System.out.printf("LengthR: %d\n", lengthR(primeiro));
