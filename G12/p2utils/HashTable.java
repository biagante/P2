...
public class HashTable<E> {
  ...
  private int hashFcn(String str) {
	...
	//devolve um array com todas as chaves existentes na tabela de dispersão
	public String[] keys(){
	...
	//Devolve uma representação da tabela de dispersão em cadeia de carac-
	//teres de acordo com o seguinte formato: {(k 1 , e 1 ), ..., (k n , e n )}
